    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div v-for="event in events_list" :key="event.id">
                <h1>
                    <router-link :to="'/articles/' + event.id">{{ event.event_date }}</router-link>
                </h1>
                <p>
                    {{ event.details }}
                </p>
            ...
            <div class="box-header with-border">
                <a name="2018-03-06"></a>
                <h4> 星期四(木) <router-link to="/admin/event/create"><i class="fa fa-plus-square pull-right"></i><span class="pull-right text-muted"> 日程: 3</span></router-link></h4>
            </div>
